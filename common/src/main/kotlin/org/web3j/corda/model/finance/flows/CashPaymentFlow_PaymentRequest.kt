...
data class CashPaymentFlow_PaymentRequest(
    val amount: AmountCurrency,
    val anonymous: kotlin.Boolean,
    val issuerConstraint: kotlin.collections.List<org.web3j.corda.model.core.identity.Party>,
    val recipient: org.web3j.corda.model.core.identity.Party? = null,
